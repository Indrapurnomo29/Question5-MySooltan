...
public class StepLoginFailed {
    ...
    public void Open_the_chrome_and_launch_Demo_Midtrans_site_successfully() throws Throwable {
//        System.out.println("This step user open the chrome and launch Demo Midtrans site for buy pillow");
    ...
    public void User_input_email_address_and_password_with_entered_are_incorrect() throws Throwable {
//        System.out.println("This step user input email address and password");
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("user_password")).sendKeys("Nusantara");
        Thread.sleep(5000);
    }

    @Then("^User not successfully login$")
    public void User_not_successfully_login() throws Throwable {
