...
public class StepCreditCardFailed {
    WebDriver driver;

    @Given("^User open chrome and launch Demo Midtrans site to buy pillow$")
    public void User_open_chrome_and_launch_Demo_Midtrans_site_to_buy_pillow() throws Throwable {
//        System.out.println("This step user open chrome to buy pillow");
    ...
    public void The_credential_entered_are_incorrect_to_buy_pillow_in_Demo_Midtrans_site() throws Throwable {
//        System.out.println("This step user input valid data to buy pillow");
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"application\"]/div/div[2]/div[2]/input")).sendKeys("4711111111111115");
        Thread.sleep(1000);
    ...
    public void User_not_successfully_buy_pillow() throws Throwable {
